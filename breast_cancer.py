...
dataset1 = pd.read_csv('breast-cancer-wisconsin.data')
x1 = dataset1.iloc[:,[3,5]].values
y1 = dataset1.iloc[:, 10].values
#2 beningn
#4 malign
#Task: The student must use Radial Basis Function Neural Network to classify three sample datasets, then interpret the results by comparing them.
...
plt.ylabel('Epithalial Cell Size')
plt.legend()
plt.show()
